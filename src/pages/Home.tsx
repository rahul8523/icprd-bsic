        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
          ...
          >
            <h1 className="text-6xl font-bold mb-6">
              Bihar's First Startup<br />Incubation Centre
            </h1>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-[#AC7E4F] font-bold">{story.funding}</div>
                      <div className="text-sm text-gray-600">Funding</div>
                    </div>
                    <div className="text-center">
                      <div className="text-[#AC7E4F] font-bold">{story.users}</div>
                      <div className="text-sm text-gray-600">Users</div>
                    </div>
                    <div className="text-center">
                      <div className="text-[#AC7E4F] font-bold">{story.growth}</div>
